...
use App\Http\Controllers\Api\Member\PayHereController as MemberPayHereController;
...
Route::middleware('auth:sanctum')->group(function () {
    ...
    Route::middleware('role:member')->prefix('member')->name('api.member.')->group(function () {
        ...
        Route::post('/payments/{payment}/pay-online', [MemberPayHereController::class, 'initiatePayment'])->name('payments.pay-online');
